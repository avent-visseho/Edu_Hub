  ...
  },
  {
    ...
    entrees: [
      ...
      },
      {
        ...
        pictogramme: '📚',
        href: '/classes',
        libellePersonnel: { PARENT: 'Classes de mes enfants', PERSONNEL: 'Ma classe' },
        icone: BookOpen,
      ...
      },
      {
        ...
        pictogramme: '📋',
        href: '/inscriptions',
        libellePersonnel: { PARENT: 'Inscriptions de mes enfants', PERSONNEL: 'Mon inscription' },
        icone: ClipboardPen,
  ...
  },
  {
    ...
    entrees: [
      ...
      },
      {
        ...
        pictogramme: '🏆',
        href: '/resultats',
        libellePersonnel: { PARENT: 'Résultats de mes enfants', PERSONNEL: 'Mes résultats' },
        icone: Award,
    ...
    entrees: [
      {
        ...
        pictogramme: '🧭',
        href: '/orientation',
        libellePersonnel: { PARENT: 'Orientation de mes enfants', PERSONNEL: 'Mon orientation' },
        icone: Compass,
      ...
      },
      {
        ...
        pictogramme: '💡',
        href: '/projets',
        libellePersonnel: { PARENT: 'Projets de mes enfants', PERSONNEL: 'Mes projets' },
        icone: Lightbulb,
      ...
      },
      {
        ...
        pictogramme: '💼',
        href: '/emploi',
        libellePersonnel: { PARENT: 'Candidatures de mes enfants', PERSONNEL: 'Mes candidatures' },
        icone: Briefcase,
    ...
    entrees: [
      {
        ...
        pictogramme: '💶',
        href: '/bourses',
        libellePersonnel: { PARENT: 'Bourses de mes enfants', PERSONNEL: 'Mes bourses' },
        icone: Landmark,
      ...
      },
      {
        ...
        pictogramme: '🚌',
        href: '/transport',
        libellePersonnel: { PARENT: 'Transport de mes enfants', PERSONNEL: 'Mon transport' },
        icone: Bus,
      ...
      },
      {
        ...
        pictogramme: '🛏️',
        href: '/logement',
        libellePersonnel: { PARENT: 'Logement de mes enfants', PERSONNEL: 'Mon logement' },
        icone: BedDouble,
      ...
      },
      {
        ...
        pictogramme: '📖',
        href: '/bibliotheque',
        libellePersonnel: { PARENT: 'Emprunts de mes enfants', PERSONNEL: 'Mes emprunts' },
        icone: Library,
